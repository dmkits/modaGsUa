...
module.exports.init = function(app){
    ...
    app.get("/mobile/reports/getSalesCRRetsForCashier", function(req, res){
        ...
        for(var condItem in req.query){
            ...
            else conditions["querySalesCRRets."+condItem]= req.query[condItem];
        }
        querySalesCRRets.getDataItemsForTable(req.dbUC,{tableColumns:tSalesCRRetsForCashierTableColumns,

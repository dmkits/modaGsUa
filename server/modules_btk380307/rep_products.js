...
module.exports.init = function(app){
    ...
    var tProdsSalesTableColumns=[
        {data:"ChID", name:"Код рег.", width:75, type:"text",align:"center", visible:false, dataSource:"t_SaleD"},
        {data:"OurID", name:"Код фирмы", width:50, type:"text",align:"center", visible:false,
            dataSource:"t_Sale", sourceField:"OurID", linkCondition:"t_Sale.ChID=t_SaleD.ChID"},
        {data:"StockID", name:"Код склада", width:50, type:"text",align:"center", visible:false, dataSource:"t_Sale"},
        {data:"CRID", name:"Код кассы", width:50, type:"text",align:"center", visible:false, dataSource:"t_Sale"},
        ...
        {data:"DocDate", name:"Дата чека", width:55, type:"dateAsText",align:"center", visible:true, dataSource:"t_Sale"},
        ...
        {data:"Barcode", name:"Штрихкод", width:90, type:"text", align:"center", visible:false, dataSource:"t_SaleD"},
        ...
        {data:"UM", name:"Ед. изм.", width:45, type:"text", align:"center", dataSource:"t_SaleD" },
    ...
    var tProdsSalesCRRetsTableColumns=[
        {data:"ChID", name:"Код рег.", width:75, type:"text",align:"center", visible:false, dataSource:"querySalesCRRets"},
        {data:"OurID", name:"Код фирмы", width:50, type:"text",align:"center", visible:false, dataSource:"querySalesCRRets"},
        {data:"StockID", name:"Код склада", width:50, type:"text",align:"center", visible:false, dataSource:"querySalesCRRets"},
        {data:"CRID", name:"Код кассы", width:50, type:"text",align:"center", visible:false, dataSource:"querySalesCRRets"},
        {data:"CRName", name:"Касса", width:250, type:"text", visible:false,
        ...
        {data:"Barcode", name:"Штрихкод", width:90, type:"text", align:"center", visible:false, dataSource:"querySalesCRRets"},
        ...
        {data:"UM", name:"Ед. изм.", width:45, type:"text", align:"center", dataSource:"querySalesCRRets" },
    ...
    var tProdsRemsTableColumns=[
        {data:"OurID", name:"Код фирмы", width:50, type:"text",align:"center", visible:false, dataSource:"t_Rem"},
        {data:"StockID", name:"Код склада", width:50, type:"text",align:"center", visible:false, dataSource:"t_Rem"},
        {data:"PLID", name:"Код прайс-листа", width:50, type:"text",align:"center", visible:false,
            dataSource:"r_Stocks", sourceField:"PLID", linkCondition:"r_Stocks.StockID=t_Rem.StockID"},
        {data:"ProdChID", name:"Код рег. товара", width:75, type:"text",align:"center", visible:false,
            dataSource:"r_Prods", sourceField:"ChID", linkCondition:"r_Prods.ProdID=t_Rem.ProdID"},
        {data:"Article1", name:"Артикул1 товара", width:200, type:"text",align:"center",
            dataSource:"r_Prods", sourceField:"Article1"},
        ...
        //{data:"Barcode", name:"Штрихкод", width:90, type:"text", dataSource:"t_Rem", visible:false},
        ...
        {data:"UM", name:"Ед. изм.", width:45, type:"text", align:"center", visible:false, dataSource:"r_Prods", sourceField:"UM"},
    ...
    var tProdsMovesTableColumns=[
        {data:"OurID", name:"Код фирмы", width:50, type:"text", visible:false,align:"center", dataSource:"queryProdMove"},
        {data:"StockID", name:"Код склада", width:50, type:"text", visible:false,align:"center", dataSource:"queryProdMove"},
        {data:"ProdChID", name:"Код рег. товара", width:75, type:"text", visible:false,align:"center",
        ...
        {data:"Article1", name:"Артикул1 товара", width:200, type:"text",align:"center",
            dataSource:"r_Prods", sourceField:"Article1"},
        //{data:"Barcode", name:"Штрихкод", width:90, type:"text",align:"center", dataSource:"t_Rem", visible:false},
        {data:"ProdID", name:"Код товара", width:50, type:"text",align:"center", visible:true, dataSource:"queryProdMove"},
        {data:"ProdName", name:"Наименование товара", width:350, type:"text",
            dataSource:"r_Prods", sourceField:"ProdName" },
        {data:"UM", name:"Ед. изм.", width:45, type:"text", align:"center", dataSource:"r_Prods", sourceField:"UM"},
        {data:"DocDate", name:"Дата", width:60, type:"dateAsText",align:"center"},
        {data:"DocCode", name:"Код документа", width:50, type:"text",align:"center", visible:false,

...
module.exports.routes=[//-- App routes --
    ...
    { path:'/pageDocRecSrcPosData/:recChID/:action/:srcPosID', componentUrl:'/mobile/pageDocRec_SrcPosData', options:{ignoreCache:true} },
...
module.exports.init = function(app){
    ...
    app.get("/mobile/pageDocRec_SrcPosData", function(req,res){
        res.sendFile(appViewsPath+'mobile/pageDocRec_SrcPosData.html');
    });
    ...
    //     t_Rec.getDataItemForTable(req.dbUC,{tableColumns:tVensListTableColumns,conditions:conditions},

...
module.exports.validateModule = function(errs, nextValidateModuleCallback){
    dataModel.initValidateDataModels(
        [t_Exc,t_ExcD,r_DBIs,r_Ours,r_Stocks,r_Comps,r_Currs,r_States,r_StateDocs,r_StateDocsChange,zf_CanChangeDoc,r_Prods], errs,
...
module.exports.init = function(app){
    var tExcsListTableColumns=[
        {data:"ChID", name:"Код рег.", width:75, type:"text",align:"center", readOnly:true, visible:false, dataSource:"t_Exc"},
        ...
        {data:"OurID", name:"Код фирмы", width:50, type:"text",align:"center", visible:false, dataSource:"t_Exc"},
        ...
        {data:"StockID", name:"Код склада", width:50, type:"text",align:"center", visible:false, dataSource:"t_Exc"},
        ...
        {data:"NewStockID", name:"Код нов. склада", width:70, type:"text",align:"center", visible:false, dataSource:"t_Exc"},
        ...
        {data:"TDiffQty", name:"Отклон. по кол-ву", width:75, type:"numeric", dataResultFunction:"TNewQty-TQty"},
        ...
        {data:"TDiffSumCC", name:"Отклон. по сумме", width:85, type:"numeric", dataResultFunction:"TNewSumCC-TSumCC"},
        {data:"StateCode", name:"Код статуса", width:50, type:"text",align:"center", readOnly:true, visible:false, dataSource:"t_Exc"},
        ...
        {data:"CanChangeDoc", name:"Изменение разрешено", width:85, type:"text",align:"center", readOnly:true, visible:false,
            dataFunction:"dbo.zf_CanChangeDoc(11021,t_Exc.ChID,t_Exc.StateCode)"},
        {data:"StateCodeCashierConfirm", name:"StateCodeConfirm", width:0, type:"text", readOnly:true, visible:false,
            dataFunction:"CASE t_Exc.StateCode When 50 Then 51 When 56 Then 57 Else NULL END"},
        {data:"StateCodeCashierRetrieve", name:"StateCodeRetrieve", width:0, type:"text", readOnly:true, visible:false,
    ...
    var tExcDTableColumns=[
        {data:"ChID", name:"Код рег.", width:75, type:"text", align:"center", dataSource:"t_ExcD", identifier:true, readOnly:true, visible:false},
        {data:"SrcPosID", name:"№ п/п", width:45, type:"numeric", align:"center", dataSource:"t_ExcD", identifier:true, readOnly:true },
        {data: "Article1", name:"Артикул1 товара", width:200, type:"text",align:"center", readOnly:true, visible:false,
        ...
        {data:"Barcode", name:"Штрихкод", width:90, type:"text", align:"center", dataSource:"t_ExcD", visible:false, readOnly:true},
        ...
        {data:"UM", name:"Ед. изм.", width:45, type:"text", align:"center", dataSource:"t_ExcD", sourceField:"UM", readOnly:true},
        {data:"PPID", name:"Партия", width:50, type:"numeric", align:"center", visible:false, readOnly:true},
        ...
        {data:"PLID", name:"Прайс-лист", width:65, type:"text",align:"center", visible:false, readOnly:true,
        ...
        {data:"SumCC", name:"Сумма", width:85, type:"numeric2", dataSource:"t_ExcD",sourceField:"SumCC_wt", readOnly:true},
        {data:"NewSumCC", name:"Факт. сумма", width:85, type:"numeric2", dataFunction:"t_ExcD.NewQty*t_ExcD.PriceCC_wt", readOnly:true}
    ];

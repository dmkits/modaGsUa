...
module.exports.init = function(app){
    ...
    var tRecDTableColumns=[
        ...
        {data:"PGrName", name:"Бренд товара", width:105,
        ...
        {data:"PCatName", name:"Коллекция товара", width:105,
        ...
        {data:"PGrName2", name:"Вид товара", width:120,
        ...
        {data:"PGrName3", name:"Состав товара", width:160,

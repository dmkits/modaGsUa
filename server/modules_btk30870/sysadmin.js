...
module.exports.init = function(app){
    ...
    module.exports.getDBUserData= function(dbUC,callback){
        z_Sys.getDataItem(dbUC,
            {fields:["SysID","SrvPack","DBType","DBInfo",
                ...
                "dbUserName","EmpID","EmpName","EmpRole","EmpRoleName"],
                fieldsFunctions:{"dbUserName":"SUSER_NAME()",
                ...
                fieldsSources:{"EmpRole":"ir_UserRoles.UserRoleAlias","EmpRoleName":"ir_UserRoles.UserRoleName"},
                leftJoinedSources:{"ir_UserRoles":"ir_UserRoles.UserRoleID=(select UserRoleID from r_Users where UserName=SUSER_NAME())"},
                top:"Top 1", order:"SysID desc", withoutConditions:true},
    ...
    var userVisiblePass="****************",
        loginsTableColumns=[
            ...
            {data: "UserRoleID", name: "User role ID", width: 120, dataSource:"r_Emps", visible:false},
            {data: "UserRoleName", name: "User role", width: 120,
                dataSource:"ir_UserRoles", sourceField:"UserRoleName", linkCondition:"ir_UserRoles.UserRoleID=r_Emps.UserRoleID",
            ...
            {data: "PswrdNote", name: "Password note", width: 150, type: "text", readOnly:true, visible:true,
                childDataSource:"ir_UserData", sourceField:"pswrdNote", childLinkCondition:"ir_UserData.UserID=r_Users.UserID"},
    ...
    app.get('/sysadmin/logins/getDataForUserRoleCombobox', function(req,res){  //ShiftPostID
        ir_UserRoles.getDataItemsForTableCombobox(req.dbUC,{ comboboxFields:{"UserRoleID":"UserRoleID","UserRoleName":"UserRoleName" },
                source:"ir_UserRoles",fields:["UserRoleID","UserRoleName"], order:"UserRoleID"},
            function(result){
                res.send(result);
            });
    });

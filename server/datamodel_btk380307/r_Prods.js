...
module.exports.modelData = { tableName:"r_Prods",idField:"ProdID",
    fields:["ChID","ProdID","ProdName","UM","Country","Notes", "Note1","Note2","Note3", "Article1","Article2","Article3","Weight","Age",
        ...
        "CstProdCode", "PriceWithTax", "TaxFreeReason", "TaxTypeID",
        "MinPriceMC","MaxPriceMC","MinRem",
        "CstDty","CstPrc","CstExc","StdExtraR","StdExtraE","MaxExtra","MinExtra",
        "UseAlts","UseCrts",
        "LExpSet","EExpSet", "File1","File2","File3", "AutoSet",
        "Extra1","Extra2","Extra3","Extra4","Extra5","Norma1","Norma2","Norma3","Norma4","Norma5",
